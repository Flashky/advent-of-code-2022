...
- During the 60th cycle, register ``X`` has the value ``19``, so the signal strength is 60 * 19 = <code><b>1140.</b></code>
- During the 100th cycle, register ``X`` has the value ``18``, so the signal strength is 100 * 18 = <code><b>1800.</b></code>
- During the 140th cycle, register ``X`` has the value ``21``, so the signal strength is 140 * 21 = <code><b>2940.</b></code>
- During the 180th cycle, register ``X`` has the value ``16``, so the signal strength is 180 * 16 = <code><b>2880.</b></code>
- During the 220th cycle, register ``X`` has the value ``18``, so the signal strength is 220 * 18 = <code><b>3960.</b></code>
